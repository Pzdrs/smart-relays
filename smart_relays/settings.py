"""
Django settings for smart_relays project.
...
WSGI_APPLICATION = 'smart_relays.wsgi.application'
...
STATICFILES_DIRS = [
    *[os.path.join(BASE_DIR, app, 'static') for app in ('smart_relays', 'relays', 'accounts')]
]
